...
public class Cuboid {
    ...
    public boolean containsBlock(Location loc){
        return getBlocks().stream().anyMatch(b -> b.getLocation().equals(loc));
    }

    public boolean containsBlock(Block b){
        return containsBlock(b.getLocation());
    }
    ...
    public List<Location> getBounds(){
        ...
        for (int x = xMin; x < xMax; x++){
            bounds.add(new Location(world, x, yMin, zMin));
        }

        for (int z = zMin; z < zMax; z++){
            bounds.add(new Location(world, xMax, yMin, z));
        }

        for (int x = xMax; x > xMin; x--){
            bounds.add(new Location(world, x, yMin, zMax));
        }

        for (int z = zMax; z > zMin; z--){
            bounds.add(new Location(world, xMin, yMin, z));
        }
        return bounds;
    }
